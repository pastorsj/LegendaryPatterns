...
public class CollectionParseTest {
	...
	public void testBasic() {
		...
		assertEquals("String", ParsingFieldUtil.typeFieldCollections(s));
	...
	public void testBrackets() {
		...
		assertEquals("List\\<Integer\\>", ParsingFieldUtil.typeFieldCollections(s));
	}
	...
	public void testBracketsCommas() {
		...
		assertEquals("Map\\<Integer, String\\>", ParsingFieldUtil.typeFieldCollections(s));
	...
	public void testNestedBracketsCommas() {
		...
		assertEquals("Map\\<List\\<List\\<List\\<Map\\<String, Integer\\>\\>\\>\\>, String\\>",
				ParsingFieldUtil.typeFieldCollections(s));
	}
}
