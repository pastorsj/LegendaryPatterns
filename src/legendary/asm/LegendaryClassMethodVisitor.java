...
/**
 * This class is called whenever a method is called inside of another method
...
public class LegendaryClassMethodVisitor extends MethodVisitor {
	 ...
	 *            the api
	 * @param decorated
	 *            The current Method Visitor being decorated
	 * @param legendaryClass
	 *            (see field)
	 * @param legendaryModel
	 *            (see field)
	 * @param legendaryMethod
	 *            (see field)
	 */
	...
	public void visitMethodInsn(int opcode, String owner, String name,
		...
		if (name.contains("<init>")) {
			...
			if (n.contains("/")) {
				...
				n = n.substring(0, n.lastIndexOf(".")) + "::"
						+ n.substring(n.lastIndexOf(".") + 1, n.length());
			}
		...
		ownerClass = ownerClass.substring(0, ownerClass.lastIndexOf("."))
